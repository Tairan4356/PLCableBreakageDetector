import sys
sys.path.insert(0, "/home/hutao/data3/LiangProjects/PLCableBreakageDetector/ultralytics")
# 现在就可以导入Yolo类了
...
if __name__ == '__main__':
    ...
    model = YOLO('/home/hutao/data3/LiangProjects/PLCableBreakageDetector/runs/multi/IEEE23/weights/best.pt')  # 加载自己训练的模型# Validate the model
    ...
    metrics = model.val(data='/home/hutao/data3/LiangProjects/PLCableBreakageDetector/ultralytics/datasets/bdd-multi-Cable.yaml',device=[0],task='multi',name='val',iou=0.6,conf=0.001,batch=1)  # batch 1 cause onnx and tensort do only batch 1 #no arguments needed, dataset and settings remembered
