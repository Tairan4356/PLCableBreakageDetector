...
if __name__ == '__main__':
    ...
    model.train(data='/home/hutao/data1/FAN/YOLOv8-multi-task-PLCable-Colab/ultralytics/datasets/bdd-multi-Cable.yaml', rect=True, batch=32, epochs=3, imgsz=(640,640), device=[0,1], name='PaperBadr-Colab', val=True, task='multi', pretrained=False, cache=False) #rect=True
